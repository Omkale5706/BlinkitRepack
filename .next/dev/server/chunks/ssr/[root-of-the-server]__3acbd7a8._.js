...
;
const metadata = {
    title: "Blinkit RePack - Reduce Waste, Sell Sealed Packs",
    description: "List your unused sealed packaged food items with more than 30 days expiry. Buyers can purchase them at lower prices.",
    generator: "v0.app",
    icons: {
        icon: [
            {
